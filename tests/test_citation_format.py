...
def _write_minimal_manifest(pack_dir):
...
def test_cli_retrieve_csv_citation_shows_row_range(mock_search_pack, tmp_path):
...
@patch("agentpack.retrieve.search_pack")
def test_cli_retrieve_pdf_citation_unchanged(mock_search_pack, tmp_path):
    mock_search_pack.return_value = [
        {
